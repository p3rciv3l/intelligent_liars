...
- [`truth_editing_implementation_handoff.md`](truth_editing_implementation_handoff.md) — fresh-agent entry point, current implementation boundary, ordered work plan, and execution gates.
