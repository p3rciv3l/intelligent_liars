...
8. **Grouping and uniqueness:** every `scenario_id` equals its `split_group_id`; batch IDs are unique; collision check against `synthetic/paired_scenarios.jsonl` returned **0 collisions**.
